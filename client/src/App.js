...
import HomeUlDepart from "./page/admin/homeUlDepart";
import HomeUlHome from "./page/admin/homeUlHome";
function App() {
  return (
    <BrowserRouter>
    <Routes>
      ...
      <Route path="/admin/ultilitiesDepart" element={<HomeUlDepart/>}> </Route>
      <Route path="/admin/ultilitiesHome" element={<HomeUlHome/>}> </Route>
